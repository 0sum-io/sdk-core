...
;(function(ChainId) {
  ...
  ChainId[
    (ChainId['ROLLUP'] = (_Number = /*#__PURE__*/ Number(process.env.REACT_APP_CHAIN_ID)) != null ? _Number : 123123123)
  ] = 'ROLLUP'
...
var _process$env$REACT_AP,
  ...
  _process$env$REACT_AP4,
  _process$env$REACT_AP5,
  _process$env$REACT_AP6,
...
var ROLLUP_ADDRESSES = {
  v3CoreFactoryAddress:
    (_process$env$REACT_AP = process.env.REACT_APP_V3_CORE_FACTORY_ADDRESS) != null
      ? _process$env$REACT_AP
      : '0x0000000000000000000000000000000000000123',
  multicallAddress:
    (_process$env$REACT_AP2 = process.env.REACT_APP_MULTICALL_ADDRESS) != null
      ? _process$env$REACT_AP2
      : '0x0000000000000000000000000000000000000123',
  quoterAddress:
    (_process$env$REACT_AP3 = process.env.REACT_APP_QUOTER_ADDRESS) != null
      ? _process$env$REACT_AP3
      : '0x0000000000000000000000000000000000000123',
  v3MigratorAddress:
    (_process$env$REACT_AP4 = process.env.REACT_APP_V3_MIGRATOR_ADDRESS) != null
      ? _process$env$REACT_AP4
      : '0x0000000000000000000000000000000000000123',
  nonfungiblePositionManagerAddress:
    (_process$env$REACT_AP5 = process.env.REACT_APP_NONFUNGIBLE_POSITION_MANAGER_ADDRESS) != null
      ? _process$env$REACT_AP5
      : '0x0000000000000000000000000000000000000123',
  tickLensAddress:
    (_process$env$REACT_AP6 = process.env.REACT_APP_TICK_LENS_ADDRESS) != null
      ? _process$env$REACT_AP6
      : '0x0000000000000000000000000000000000000123'
} // BNB v3 addresses
...
var CHAIN_TO_ADDRESSES_MAP =
  ((_CHAIN_TO_ADDRESSES_M = {}),
  (_CHAIN_TO_ADDRESSES_M[exports.ChainId.ROLLUP] = ROLLUP_ADDRESSES),
