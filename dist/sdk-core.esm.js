...
(function (ChainId) {
  ...
  ChainId[ChainId["ROLLUP"] = (_Number = /*#__PURE__*/Number(process.env.REACT_APP_CHAIN_ID)) != null ? _Number : 123123123] = "ROLLUP";
...
var SUPPORTED_CHAINS = [ChainId.ROLLUP, ChainId.MAINNET, ChainId.OPTIMISM, ChainId.OPTIMISM_GOERLI, ChainId.ARBITRUM_ONE, ChainId.ARBITRUM_GOERLI, ChainId.POLYGON, ChainId.POLYGON_MUMBAI, ChainId.GOERLI, ChainId.SEPOLIA, ChainId.CELO_ALFAJORES, ChainId.CELO, ChainId.BNB, ChainId.AVALANCHE, ChainId.BASE, ChainId.BASE_GOERLI];
...
var _process$env$REACT_AP, _process$env$REACT_AP2, _process$env$REACT_AP3, _process$env$REACT_AP4, _process$env$REACT_AP5, _process$env$REACT_AP6, _CHAIN_TO_ADDRESSES_M, _GOVERNANCE_ALPHA_V1_, _GOVERNANCE_BRAVO_ADD, _MERKLE_DISTRIBUTOR_A, _ARGENT_WALLET_DETECT, _SOCKS_CONTROLLER_ADD;
...
var ROLLUP_ADDRESSES = {
  v3CoreFactoryAddress: (_process$env$REACT_AP = process.env.REACT_APP_V3_CORE_FACTORY_ADDRESS) != null ? _process$env$REACT_AP : '0x0000000000000000000000000000000000000123',
  multicallAddress: (_process$env$REACT_AP2 = process.env.REACT_APP_MULTICALL_ADDRESS) != null ? _process$env$REACT_AP2 : '0x0000000000000000000000000000000000000123',
  quoterAddress: (_process$env$REACT_AP3 = process.env.REACT_APP_QUOTER_ADDRESS) != null ? _process$env$REACT_AP3 : '0x0000000000000000000000000000000000000123',
  v3MigratorAddress: (_process$env$REACT_AP4 = process.env.REACT_APP_V3_MIGRATOR_ADDRESS) != null ? _process$env$REACT_AP4 : '0x0000000000000000000000000000000000000123',
  nonfungiblePositionManagerAddress: (_process$env$REACT_AP5 = process.env.REACT_APP_NONFUNGIBLE_POSITION_MANAGER_ADDRESS) != null ? _process$env$REACT_AP5 : "0x0000000000000000000000000000000000000123",
  tickLensAddress: (_process$env$REACT_AP6 = process.env.REACT_APP_TICK_LENS_ADDRESS) != null ? _process$env$REACT_AP6 : '0x0000000000000000000000000000000000000123'
}; // BNB v3 addresses
