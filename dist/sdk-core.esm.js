...
var ROLLUP_ADDRESSES = {
  v3CoreFactoryAddress: process.env.REACT_APP_V3_CORE_FACTORY_ADDRESS,
  multicallAddress: process.env.REACT_APP_MULTICALL_ADDRESS,
  quoterAddress: process.env.REACT_APP_QUOTER_ADDRESS,
  v3MigratorAddress: process.env.REACT_APP_V3_MIGRATOR_ADDRESS,
  nonfungiblePositionManagerAddress: process.env.REACT_APP_NONFUNGIBLE_POSITION_MANAGER_ADDRESS,
  tickLensAddress: process.env.REACT_APP_TICK_LENS_ADDRESS
}; // BNB v3 addresses
